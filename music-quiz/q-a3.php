<?php
 ...
 $classTag = '懸疑／推理';
 $number = '３';
 $music = 'https://drive.google.com/file/d/1A6mWxGvQoSM1_EFHGvp1lFL1Nytk8_Ue/preview';
 $ansTitle = '無頭騎士異聞錄DuRaRaRa!! OP1 (2010)';
 $ansVideo = 'frfompwkApw';
 $ansVideoS = '0';
 $ansImg = '';
 $ansDescript = '';
 $musicLocal = 'a3';//本機音樂檔案
